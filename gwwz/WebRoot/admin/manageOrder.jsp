...
<html>
  ...
  <tr>
    <td height="147" colspan="4">
		...
		<!--Statistics the total number of orders：<%=request.getAttribute("sumCount")%>, which has been confirmed:<%=request.getAttribute("queren")%>, not confirmed:<%=request.getAttribute("wqueren")%>，returns：<%=request.getAttribute("tuihuo")%>-->
